...
-> offerText (String): Description of the special offer provided by the 
education institute.
...
-> enrollStudentInCourse(int courseId, String studentName): Simulates the 
enrollment process and prints a message when a student -> enrolls in a 
course.
...
-> institute (EducationInstitute): Reference to the education institute
 where the student interacts.
class Main :
...
Sample Output :Available Courses:
